            ...
            <CommunityInfoContainer>
              {UserDataContext?.userData ? (
                <>
                      ...
                      .map((app) => (
                        <PopularGameItem key={app._id}>
                          ...
                          <PopularGameDescription
                            onClick={() =>
                              history.push(
                                "/" + APP_KEYS.ROUTER_KEYS.APPS + "/" + app._id
                              )
                            }
                          >
                            To App Page
                  ...
                  <CommunitySubtitle style={{lineHeight: '20px', position: 'absolute', top: '1rem', right: 0, width: '24rem'}}>
                    In Community Page you can add post <br /> with whatever image, title, description you want.
                    <br /> Share your thoughts and ideas.</CommunitySubtitle>
                  <CreatePost onClick={() => history.push('/' + APP_KEYS.ROUTER_KEYS.COMMUNITY + '/' + APP_KEYS.ROUTER_KEYS.CREATE)}>Create Your Own Post</CreatePost>
                </>
              ) : (
                <>
                  <CommunityInfoText>
